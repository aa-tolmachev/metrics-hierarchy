...
var UsersApiRequestFactory = (function (_super) {
    ...
    UsersApiRequestFactory.prototype.rolesGet = function (_options) {
        var _a, _b, _c;
    ...
    UsersApiRequestFactory.prototype.usersGet = function (role, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (role === null || role === undefined) {
                            throw new baseapi_1.RequiredError("UsersApi", "usersGet", "role");
                        }
                        localVarPath = '/users';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        if (role !== undefined) {
                            requestContext.setQueryParam("role", ObjectSerializer_1.ObjectSerializer.serialize(role, "string", ""));
                        }
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
...
var UsersApiResponseProcessor = (function () {
    ...
    UsersApiResponseProcessor.prototype.rolesGetWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_l.label) {
                    ...
                    case 1:
                        body = _b.apply(_a, [_d.apply(_c, [_l.sent(), contentType]),
                            "Array<RolesGet200ResponseInner>", ""]);
    ...
    UsersApiResponseProcessor.prototype.usersGetWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
